        ...
        else
        {
            ...
            if(isEnemy1Alive)
            {
                if((enemy1).getHealth() <= 0)
                {
                    ...
                    whatKindOfEnemyDied = enemy1.getEnemyKind();
                    delete &enemy1;
                    isEnemy1Alive = 0;
                    enemyCnt--;                   
            ...
            if(isEnemy2Alive)
            {
                if ((enemy2).getHealth() <= 0)
                {
                    ...
                    whatKindOfEnemyDied = enemy2.getEnemyKind();
                    delete &enemy2;
                    isEnemy2Alive = 0;
                    enemyCnt--;
                    cout<<"("<<enemyDiedGetMyCoins(player)<<" COINS)"<<endl;
            ...
            if(isEnemy3Alive)
            {
                if ((enemy3).getHealth() <= 0)
                {
                    ...
                    whatKindOfEnemyDied = enemy3.getEnemyKind();
                    delete &enemy3;
                    isEnemy3Alive = 0;
                    enemyCnt--;
                    cout<<"("<<enemyDiedGetMyCoins(player)<<" COINS)"<<endl;
        ...
        else
        {
            ...
            if(isEnemy1Alive)
            {
                if((enemy).getHealth() <= 0)
                {
                    ...
                    whatKindOfEnemyDied = enemy.getEnemyKind();
                    delete &enemy;
                    isEnemy1Alive = 0;
                    enemyCnt--;                   
                    cout<<"("<<enemyDiedGetMyCoins(player)<<" COINS)"<<endl;
            ...
            for(int j{0}; j<30; j++)
            {
                ...
                {      
                    if((enemySk[j]).getHealth() <= 0)
                    {
                        ...
                        whatKindOfEnemyDied = enemySk[j].getEnemyKind();
                        delete &enemySk[j];
            ...
            for(int j{0}; j<10; j++)
            {
                ...
                {      
                    if((enemyKg[j]).getHealth() <= 0)
                    {
                        ...
                        whatKindOfEnemyDied = enemyKg[j].getEnemyKind();
                        delete &enemyKg[j];
